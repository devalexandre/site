...
**Repo: https://github.com/moleculer-go/moleculer-examples/tree/master/conduit#readme**
...
- MongoDB database with [moleculer-db](https://github.com/moleculer-go/moleculer-db) and [moleculer-db-adapter-mongoose](https://github.com/moleculer-go/moleculer-db/tree/master/packages/moleculer-db-adapter-mongoose) modules
- NATS transporter
- Redis cacher
- [Traefik](https://traefik.io/) reverse proxy (in micro arch)
- static frontend

**Repo: https://github.com/moleculer-go/moleculer-examples/blob/master/blog#readme**

## Short examples
The main Moleculer repository contains [some examples](https://github.com/moleculer-go/moleculer/blob/master/examples/).
...
[Source code is available on Github](https://github.com/moleculer-go/moleculer/blob/master/examples/simple/index.js)
...
[Source code is available on Github](https://github.com/moleculer-go/moleculer/tree/master/examples/client-server)
...
[Source code is available on Github](https://github.com/moleculer-go/moleculer/blob/master/examples/middlewares/index.js)
...
[Source code is available on Github](https://github.com/moleculer-go/moleculer/blob/master/examples/runner)
...
[Source code is available on Github](https://github.com/moleculer-go/moleculer/blob/master/examples/loadtest)
